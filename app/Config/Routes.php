...
$routes->get('admin/history', 'Admin::history', ['filter' => 'auth:admin']);
$routes->get('admin/history/json', 'Admin::historyJson', ['filter' => 'auth:admin']);
$routes->get('admin/sidebar-stats', 'Admin::sidebarStatsJson', ['filter' => 'auth:admin']);
$routes->get('admin/history/view/(:num)', 'Admin::historyView/$1', ['filter' => 'auth:admin']);
